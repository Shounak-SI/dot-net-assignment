...
namespace MatchDetailsManagementSys
{
    internal class MatchDetails
    {
        ...
        {
            return $"MatchId: {MatchId}, Sports: {Sports}, MatchDateTime: {MatchDateTime}, Location: {Location}, HomeTeam: {HomeTeam}, HomeTeamScore: {HomeTeamScore}, AwayTeam: {AwayTeam}, AwayTeamScore: {AwayTeamScore}";
        }
    }
}
